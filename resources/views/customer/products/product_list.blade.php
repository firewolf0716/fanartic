...
<div class="product-list__column">
    ...
    <div class="l-column l-column--control is-nb">
        <div class="l-column--control__col u-sp"><span class="c-select c-select--sort u-sp__full" data-productfilter__button=""><span class="c-select__box u-sp__full"><span class="c-select__box__inner">絞り込む</span></span>
        </span>
        </div>
        <div class="l-column--control__col"><label class="c-select c-select--sort u-sp__full"><span class="c-select__box u-sp__full"><select name="" id=""><option value="">並び替え</option></select></span></label></div>
    </div>
    ...
    <div class="c-items c-items--04">
        ...
        <div class="c-item__column">
            ...
            <div class="c-item__price"><strong>&yen;{{number_format($product->product_price_sale)}}</strong></div>
            </div>
    ...
    {!! Form::open(array('id' => 'form_product_list','url'=>'customer/product/product_list_post', 'accept-charset' => 'UTF-8', 'novalidate')) !!}
                    ...
                    <li class="is-hassub">{{$maincategory->category_name}}
                        <ul class="product-list__nav__category__sub">
                            @foreach($subcategorys[$maincategory->category_id] as $subcategory)
                                <li><a href="{{url('customer/product/list').'/'.$topcategory->category_id.'/'.$maincategory->category_id.'/'.$subcategory->category_id}}">
            ...
            <div class="product-list__nav__item">
                <ul class="product-list__nav__column u-pc">
                    ...
                    @foreach($sizes as $size)
                        <li><a href="#" class="product-list__nav__button product-list__nav__button--size" onClick="onSizeChange({{$size->size_id}})">{{$size->size_name}}</a></li>
                    @endforeach
                    <li><a href="#" class="product-list__nav__button product-list__nav__button--size" onClick="onSizeChange('')">すべて</a></li>
                    @endif
                </ul>
            </div>
            <!--/.product-list__nav__item-->
        ...
        <li data-productfiltermodal="">
            ...
            <!--/.product-list__nav__item-->
            <div class="c-select c-select--filter c-select--modal u-sp u-sp__full" data-productfiltermodal__open=""><span class="c-select__box u-sp__full"><span class="c-select__box__inner" data-productfiltermodal__value__label="">カラーを選択</span> <input type="hidden" value="カラーを選択" data-productfiltermodal__value__key=""></span>
            </div>
        </li>
        @php
            $rangemin = '';
        ...
        <li data-productfiltermodal="">
            ...
            <div class="product-list__nav__price">
                @if($rangemin == '')
                <input type="range" name="rangemin" min="0" max="1000000" value="0" data-productlistprice__min="">
                @else
                <input type="range" name="rangemin" min="0" max="1000000" value="{{$rangemin}}" data-productlistprice__min="">
                @endif
                @if($rangemax == '')
                <input type="range" name="rangemax" min="0" max="1000000" value="1000000" data-productlistprice__max="">
                @else
                <input type="range" name="rangemax" min="0" max="1000000" value="{{$rangemax}}" data-productlistprice__max="">
                @endif
                <div class="product-list__nav__price__buttons u-pc"><a href="#" class="product-list__nav__price__button">削除</a> <a href="#" class="product-list__nav__price__button" onClick="onPriceChange()">OK</a></div>
            ...
            <div class="l-column l-column--half u-sp">
                <div class="l-column--half__col"><span class="c-button c-button--clear c-button--full" data-productfiltermodal__clear="">クリア</span></div>
                <div class="l-column--half__col"><span class="c-button c-button--submit c-button--full" data-productfiltermodal__submit="">価格を選択</span></div>
            </div>
            </div>
            <!--/.product-list__nav__item-->
            <div class="c-select c-select--filter c-select--modal u-sp u-sp__full" data-productfiltermodal__open=""><span class="c-select__box u-sp__full"><span class="c-select__box__inner" data-productfilterprice__label="">価格を選択</span></span>
            </div>
        </li>
        </ul>
        <div class="l-column l-column--half u-sp">
        <div class="l-column--half__col"><input type="reset" class="c-button c-button--clear c-button--full" data-productfilter__clear="" value="クリア"></div>
        <div class="l-column--half__col"><button class="c-button c-button--submit c-button--full" data-productfilter__submit="">絞り込む</button></div>
        </div>
        <!--/.l-column l-column--half-->
    {{ Form::close() }}
    </div>
