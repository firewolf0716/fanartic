    ...
    <div class="members" style="padding:10px">
        ...
        <div class="members__column__content">
            ...
            <div class="c-box__content">
                ...
                <div class="c-form__row__input"><label class="c-form__radio"><input type="radio" name="sex" value="01"><i></i>男性</label> <label class="c-form__radio"><input type="radio" name="sex" value="02"><i></i>女性</label> <label class="c-form__radio"><input type="radio" name="sex" value="03"><i></i>その他</label></div>
                </div>
                <!--/.c-form__row-->
                <div class="c-form__row">
                ...
                <div class="c-form__row__input"><input type="text" class="c-form__input c-form__input--address" name="" value="1001000"> <button class="c-button c-button--sub">住所自動入力</button></div>
                </div>
                <!--/.c-form__row-->
                <div class="c-form__row">
                ...
                <div class="c-form__row__input">
                    <div class="c-form__colum">
                    <div class="c-form__colum__col"><input type="text" class="c-form__input" name="" value="東京"></div>
                    </div>
                </div>
                </div>
                <!--/.c-form__row-->
                ...
                <div class="c-form__row__input"><input type="text" class="c-form__input" name="" value="渋谷区円山町"></div>
                </div>
                <!--/.c-form__row-->
                <div class="c-form__row">
                <div class="c-form__row__label">番地<span class="c-form__require">必須</span></div>
                <div class="c-form__row__input"><input type="text" class="c-form__input" name="" value="1-1-10"></div>
                </div>
                <!--/.c-form__row-->
                <div class="c-form__row">
                ...
                <!--/.c-form__row-->
                <hr class="c-hr">
                <div class="l-button"><a href="#" class="c-button c-button--submit">提出する</a></div>
                <!--/.l-button-->
            </div>
            <!--/.c-box__content-->
            </section>
