...
<div class="">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <?php $index += 1; ?>
                            <tr>
                                ...
                                <td style="text-align:center">
                                    <a href="{{ url('admin/notifycustomer/edit/'.$notify->notify_id) }}"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
    ...
    <script>
		function deleteConfirm(notify_id) {
			...
			window.location = "{{ url('admin/notifycustomer/delete') }}" + "/" + notify_id;
		}
	</script>
