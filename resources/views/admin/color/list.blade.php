                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center">{{ __('admin.色') }}</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        @foreach($colors as $color)
                            ...
                            <tr>
                                ...
                                <td style="text-align:center">
                                    <a href="{{ url('admin/color/edit/'.$color->color_id) }}"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
