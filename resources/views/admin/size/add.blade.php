        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <input type="text" id="size_name" name="size_name" required="required" class="form-control col-md-7 col-xs-12" placeholder="{{ __('admin.サイズの名前を日本語で入力してください') }}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">{{ __('admin.英名') }}<span class="required">*</span></label>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <input type="text" id="size_name_en" name="size_name_en" required="required" class="form-control col-md-7 col-xs-12" placeholder="{{ __('admin.サイズの名前を英語で入力してください') }}">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <button id="btnSubmit" type="submit" class="btn btn-warning">{{ __('admin.サイズを追加') }}</button>
