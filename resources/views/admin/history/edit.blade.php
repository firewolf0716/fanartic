...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        {!! Form::open(array('id' => 'form_add','url'=>'admin/history/editpost','class'=>'form-horizontal','enctype'=>'multipart/form-data', 'accept-charset' => 'UTF-8', 'novalidate')) !!}
        {{ Form::hidden('id', $history->bh_id)}} 
        {{ Form::hidden('brand_id', $history->b_id)}}
        <div class="x_panel">
            <div class="x_title">
                <h4>ブランドを編集する</h4>
                <div class="clearfix"></div>
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">年<span class="required">*</span></label>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <input type="text" id="year" name="year" required="required" class="form-control col-md-7 col-xs-12" value="{{$history->year}}" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">タイトル<span class="required">*</span></label>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <input type="text" id="head" name="head" required="required" class="form-control col-md-7 col-xs-12" value="{{$history->head}}" placeholder="タイトル">
                    </div>
                </div>
                <div id="div_images">
                    <div class="form-group">
                        ...
                        <div class="radio col-md-3 col-sm-6 col-xs-12" id="div-product-image">
                            <img style="height:70px; width:70px;" src="{{url('/images/history/'.$history->figure)}}" id="history_image2">
                            <button class="btn-small" type="button" id="remove_history_image" onClick="onRemoveImg()">Remove</button>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <textarea class="form-control" id="description" name="description" cols="50" rows="10" style="margin: 0px 21px 0px 0px; height: 150px;" required>{{$history->description}}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">登録日時</label>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <input type="text" id="create_date" name="create_date" class="form-control col-md-7 col-xs-12" readonly value="{{$history->created_at}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">変更日時</label>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <input type="text" id="update_date" name="update_date" class="form-control col-md-7 col-xs-12" readonly value="{{$history->updated_at}}">
                    </div>
                </div>
