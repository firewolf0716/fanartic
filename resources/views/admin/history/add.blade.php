...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        {!! Form::open(array('id' => 'form_add','url'=>'admin/history/addpost','class'=>'form-horizontal','enctype'=>'multipart/form-data', 'accept-charset' => 'UTF-8', 'novalidate')) !!}
        <div class="x_panel">
            <div class="x_title">
                <h4>を追加</h4>
                <div class="clearfix"></div>
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <input type="text" id="year" name="year" required="required" class="form-control col-md-7 col-xs-12" placeholder="xxxx">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">タイトル<span class="required">*</span></label>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <input type="text" id="head" name="head" required="required" class="form-control col-md-7 col-xs-12" placeholder="タイトル">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <textarea class="form-control" id="description" name="description" cols="50" rows="10" style="margin: 0px 21px 0px 0px; height: 150px;" required></textarea>
                    </div>
                </div>
