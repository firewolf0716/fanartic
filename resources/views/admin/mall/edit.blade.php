...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        {{ Form::hidden('mall_id', $mall->mall_id)}}
        <div class="x_panel">
            <div class="x_title">
                <h4>Edit Mall</h4>
                <div class="clearfix"></div>
            ...
            <div class="x_content">
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <input type="text" id="mall_name" name="mall_name" required="required" class="form-control col-md-7 col-xs-12" placeholder="Enter Mall name in japanese" value="{{$mall->mall_name}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">英名<span class="required">*</span></label>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <input type="text" id="mall_name_en" name="mall_name_en" required="required" class="form-control col-md-7 col-xs-12" placeholder="Enter Mall name in English" value="{{$mall->mall_name_en}}">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <button id="btnSubmit" type="submit" class="btn btn-warning">Edit Mall</button>
