...
<div class="">
    ...
    <div class="row">
        ...
        {!! Form::open(array('id' => 'form_add','url'=>'merchant/product/update_product_count','class'=>'form-horizontal','enctype'=>'multipart/form-data', 'accept-charset' => 'UTF-8', 'novalidate')) !!}
            <div class="col-md-6">
                <div class="x_panel">
                    <div class="x_title">
                        <h4>Upload</h4>
                        ...
                        <div class="form-group" style="margin-Bottom:30px">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button id="btnSubmit" type="submit" class="btn btn-warning">csvからの在庫連携</button>
                                </span>
                            </div>
                        </div>
                    </div>
