...
CREATE TABLE `receipt_address` (
  ...
  `address_postalcode` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_state` int(11) DEFAULT NULL,
  `address_city` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_address_ex` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_province` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_county` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_address_jp` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_totalscore` double(11,0) DEFAULT NULL,
  `address_default` enum('1','0') COLLATE utf8_unicode_ci DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
